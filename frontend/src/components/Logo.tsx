    ...
    <div className={`locus-logo ${variant} ${className}`.trim()}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .locus-letter {
          ...
          background: linear-gradient(155deg, #475569 0%, #334155 35%, #1e293b 70%, #0f172a 100%);
        ...
        .locus-underline {
          ...
          align-self: stretch;
          background: linear-gradient(90deg, #334155, #475569, #334155, #475569);
        ...
        @keyframes locus-ring-glow {
          0%, 100% { border-color: rgba(51, 65, 85, 0.2); }
          50% { border-color: rgba(51, 65, 85, 0.5); box-shadow: 0 0 10px rgba(51, 65, 85, 0.12); }
        }
